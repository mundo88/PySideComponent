...
if __name__ == '__main__':
    ...
    alert = Modal(window,title='Are you absolutely sure?',message='This action cannot be undone. This will permanently delete your account and remove your data from our servers.')
